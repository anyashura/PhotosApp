...
class FullScreenPhotoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.performBatchUpdates(nil) { (result) in self.collectionView.scrollToItem(at: self.indexPath, at: UICollectionView.ScrollPosition.centeredHorizontally, animated: false)
        }
